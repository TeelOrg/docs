...
<Tabs>
  ...
  <Tab title="Stablecoin-to-fiat">
    ...
    <ResponseField name="escrowState" type="string">`awaiting_deposit` → `confirmed` → `released`.</ResponseField>
    <ResponseField name="actualUsdcReceived" type="number">USDC the escrow received. Populated after deposit confirmation.</ResponseField>
  </Tab>
</Tabs>
