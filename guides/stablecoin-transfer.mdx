...
`to_currency` is the stablecoin the recipient receives:

```bash
curl "https://api.teel.finance/quotes/fiat-to-stablecoin/best?from_currency=USD&to_currency=USDC&amount=1000" \
