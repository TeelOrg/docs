...
```bash
curl -X POST https://api.teel.finance/webhooks/subscriptions \
  -H "Authorization: Bearer $TEEL_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "url": "https://your.app/teel-webhook",
...
```json
{
  ...
  "data": {
    "payoutId": "3d1f7c20-9b8a-4e6d-bf12-7a4c9e2d1f0b",
...
```json
{
  ...
  "createdAt": "2026-05-27T09:31:02Z",
  "data": {
    "payoutId": "3d1f7c20-9b8a-4e6d-bf12-7a4c9e2d1f0b",
    "status": "processing",
    "provider": "provider_b",
    "step": "settling",
    "stepChangedAt": "2026-05-27T09:31:02Z"
  }
}
```
...
ws.onopen = () => {
  ...
  // within 10 seconds.
  ws.send(JSON.stringify({ type: "auth", apiKey: "sk_live_..." }));
};
