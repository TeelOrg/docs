...
Webhook subscription scopes (`webhooks:read` / `webhooks:write`) are on the roadmap. Today, webhook subscriptions are managed from the dashboard or by contacting support — see the [Webhooks guide](/guides/webhooks).
