...
Teel is a treasury intelligence layer for mid-market enterprise CFOs across Southeast Asia that supports cross-border payouts through **fiat-to-fiat**, **fiat-to-stablecoin**, and **stablecoin-to-stablecoin** transfers. The API lets you programmatically manage payouts, recipients, quotes, and compliance workflows.
