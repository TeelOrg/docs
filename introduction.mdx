...
The OpenAPI 3.1 spec is served at [`/openapi.json`](https://api.teel.finance/openapi.json) (or `/openapi.yaml`) on every host — import it into Postman, Insomnia, or `openapi-generator-cli` for typed clients.
